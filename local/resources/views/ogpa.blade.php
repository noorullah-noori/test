 <?php $lang = Config::get('app.locale'); $header = "include.$lang"."_header";  ?>
	...
	<div class="container">
		...
		<div class="col-md-9" style="padding-left: 5px;padding-bottom:20px;margin-top: 25px;">
			<div class="col-md-12" id="ogpa">
				<h3>About OGPA</h3>
					<div style="border-top:1px solid #f0b158;padding-top:10px;margin-top:-8px;>
				<p style="line-height:1.5;font-size:16px;text-align: justify;">
			...
			<div class="col-md-12" id="ogpa-secrat" style="margin-top:20px;">
