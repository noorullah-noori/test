        ...
        <div class="col-md-11">
                    <section class="panel">
                        <header class="panel-heading">
                            Add Event Or Seminar
                        </header>
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " id="signupForm" method="post" action="{{route('events.store')}}" novalidate="novalidate" enctype="multipart/form-data">
