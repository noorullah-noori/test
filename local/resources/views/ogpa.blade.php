@include('include.header')	
	...
	<div class="container">
		...
		<div class="col-md-9">
			<div class="col-md-12" id="ogpa" style="padding-left:40px;padding-bottom:20px">
				<h3>About OGPA</h3>
					<div style="border-top:1px solid #f0b158;padding-top:10px;margin-top:-8px;transition:all 400ms ease-out" class="hover-div">
			...
			<div class="col-md-12" id="ogpa-secrat" style="padding-left:40px">
			...
			<div class="col-md-12" id="contacts" style="padding-left:40px;padding-bottom:10%;">
				<h3 style="padding-top:10%">OGPA Contacts</h3>
					
					<div style="padding-top:2%; margin-left:-4px margin-top;">
						<div class="col-md-4 social-padding " style="">
						<div class="btn btn-success btn-circle  btn-xl" style="transition:all 400ms ease-out">
						...
						<div class="col-md-3 col-md-offset-1 social-padding ">
							<div class="btn btn-info btn-circle btn-xl" style="transition:all 400ms ease-out">
								<i class="fa fa-envelope btn-text"></i>
								<p style="font-size:14px;">info@ogpa.gov.af</p>

							</div>
						</div>
						<div class="col-md-2 col-md-offset-2 social-padding">
							<div class="btn btn-primary btn-circle btn-xl" style="transition:all 400ms ease-out">
